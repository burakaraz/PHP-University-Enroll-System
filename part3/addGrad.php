...
<?php
	...
	if($_POST["addflag"] == "add"){
			...
			$stid2 = oci_parse($conn, "begin Database.addGrad(:p_stuId,:p_deptId,:p_name,:p_surname,:p_natId,:p_email,:p_phone,:p_address,:p_password,:p_cgpa,:p_pre),:p_RESULT; end;");
	...
	$stid = oci_parse($conn, "begin Database.showGrad(:p_profile); end;");
	...
	<center><h2>Graduate Student </h2></center>
...
<center>	
		...
		<h4> Add Graduate Student </h4>
		<form action="addGrad.php" method="POST">
			...
			<p><label for="pre">Under Graduate School:</label><input type="text" name="pre" value="" required></p>
